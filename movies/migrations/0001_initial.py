    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=0, verbose_name='Release date')),
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='Indicate the amount in usd', verbose_name='Budget')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='Indicate the amount in usd', verbose_name='Fees in usa')),
                ('fees_in_world', models.IntegerField(default=0, help_text='Indicate the amount in usd', verbose_name='Fees in world')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('director', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='director')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.movie', verbose_name='movie')),
            ],
            options={
